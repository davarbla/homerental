...
class ChatApp extends StatefulWidget {
  ...
  ChatApp({required this.userChat});
...
class _ChatAppState extends State<ChatApp> {
  ...
  scrollToBottom() {
    ...
    Timer(Duration(milliseconds: 450), () {
      if (_chatViewKey != null && _chatViewKey!.currentState != null)
        _chatViewKey!.currentState!.scrollController
          ..animateTo(
            _chatViewKey!
                    .currentState!.scrollController.position.maxScrollExtent +
                ...
                return DashChat(
                  ...
                  sendButtonBuilder: ((_) {
                    return IconButton(
                        ...
                        icon: Icon(Feather.send, size: 20),
                        onPressed: () async {
    ...
    return Container(
      ...
      child: (peerAvatar != null && peerAvatar != '')
          ...
          : CircleAvatar(
              backgroundColor: Get.theme.primaryColor.withOpacity(.7),
              radius: 32,
              backgroundImage: AssetImage("assets/def_profile.png"),
            ),
      decoration: BoxDecoration(
