...
class HomeScreen extends StatelessWidget {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Container(
                padding:
                    EdgeInsets.only(left: 22, right: 18, top: 10, bottom: 10),
  ...
  Widget listNearby(final List<RentalModel> nearbys) {
    //final List<RentalModel> nearbys =
                ...
                children: [
                  ...
                  Container(
                    width: GetPlatform.isAndroid
                        ...
                        : Get.width / 1.55,
                    padding:
                        EdgeInsets.only(top: 10, left: 3, right: 5, bottom: 5),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
