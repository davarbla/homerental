...
class DetailRental extends StatelessWidget {
  ...
  DetailRental({required this.rental}) {
    isLiked.value = x.getLikedByRentId(rental.id!).length > 0;
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Container(
              margin: EdgeInsets.only(left: 15),
              padding: EdgeInsets.only(left: 20, right: 25, top: 5, bottom: 5),
              child: Text(
                "${rental.description}",
                style: TextStyle(
                  color: colorTrans1,
            ...
            Obx(
              () => x.itemReview.value.result != null &&
                      x.itemReview.value.reviews!.length > 0
  ...
  Widget newReview() {
    return InkWell(
      onTap: () {
        MyHome.showDialogInputReview(x, this.rental, x.thisUser.value);
      },
      child: Container(
      ...
      child: Container(
        ...
        child: Stack(
          children: [
            Container(
              width: thisWidth / 1.1,
              padding: EdgeInsets.only(top: 5, left: 22, right: 10, bottom: 5),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
            ...
            Positioned(
              ...
              child: Column(
                children: [
                  InkWell(
                      onTap: () {
                        print("clicked thumb up");
                        MyTheme.showToast('Dummy action...');
                      },
                      child: Icon(Feather.thumbs_up, size: 18)),
                  SizedBox(height: 20),
                  InkWell(
                      onTap: () {
                        print("clicked thumb down");
                        MyTheme.showToast('Dummy action...');
                      },
                      child: Icon(Feather.thumbs_down,
                              ...
                              Flexible(
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    spaceWidth5,
                                    Text(
                                        "${MyTheme.formatCounterNumber(e.totalLike!)}",
                                        style: TextStyle(
                                            fontSize: 11,
                            ...
                            if (!isProcessBook.value)
                              InkWell(
                                onTap: () async {
                                  ...
                                  print("method value ${idxMethod.value}");
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              spaceHeight20,
                              Container(
                                child: Image.asset("assets/green-success.gif",
                                    width: 180),
                              ),
                              spaceHeight20,
                            ],
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          margin: EdgeInsets.only(bottom: 10),
          child: Text("Payment Method", style: textBold),
        ),
        Container(
          width: Get.width,
          alignment: Alignment.center,
  ...
  static Widget childProcessing() {
    return Column(
      children: [
        ...
        spaceHeight20,
        Container(
          child: Image.asset("assets/loading2.gif", width: 120),
        ),
        spaceHeight20,
      ],
    );
  ...
  static Widget childBooking(final RentalModel rental, final MyPref myPref) {
    ...
    return Column(
      children: [
        ...
        stepProcess.value == 2 ? SizedBox(height: 1) : spaceHeight10,
          ...
          child: SfDateRangePicker(
            ...
            onSelectionChanged: (DateRangePickerSelectionChangedArgs args) {
              ...
              if (args.value is PickerDateRange) {
                String _range = DateFormat('dd/MM/yyyy')
